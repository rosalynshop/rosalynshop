...
namespace Zemi\Productslider\Controller\Adminhtml\Widget;

/**
 * Class Categories
 * @package Zemi\Productslider\Controller\Adminhtml\Widget
 */
class Categories extends \Magento\Widget\Controller\Adminhtml\Widget\Instance
{
    ...
    public function execute()
    {
        ...
        $chooser = $this->layout->createBlock('Zemi\Productslider\Block\Adminhtml\Widget\Category\Chooser')
