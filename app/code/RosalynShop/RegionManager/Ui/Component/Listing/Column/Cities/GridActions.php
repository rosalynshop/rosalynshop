...
namespace RosalynShop\RegionManager\Ui\Component\Listing\Column\Cities;
...
/**
 * Class GridActions
 * @package RosalynShop\RegionManager\Ui\Component\Listing\Column\Cities
 */
class GridActions extends ParentColumn
{
    /** Url path */
    const DATA_DELETE       = 'regionmanager/cities/delete';
    const DATA_EDIT         = 'regionmanager/cities/edit';
