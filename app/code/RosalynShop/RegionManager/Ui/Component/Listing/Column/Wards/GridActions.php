...
namespace RosalynShop\RegionManager\Ui\Component\Listing\Column\Wards;
...
{
    /** Url path */
    const DATA_DELETE       = 'regionmanager/wards/delete';
    const DATA_EDIT         = 'regionmanager/wards/edit';
