...
namespace RosalynShop\RebuildUrl\Model\Product;
...
class Url extends \Magento\Catalog\Model\Product\Url
{
    ...
    public function __construct(
        ...
        \RosalynShop\RebuildUrl\Model\Product\CategoryProcessor $categoryProcessor,
    ...
    protected function _getResource()
    {
        return ObjectManager::getInstance()->get(
            \RosalynShop\RebuildUrl\Model\ResourceModel\Product\Url::class
        );
    }
