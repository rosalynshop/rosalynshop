...
namespace RosalynShop\RebuildUrl\Model\ResourceModel\Product;
...
class Url extends \Magento\Catalog\Model\ResourceModel\Url
{
    ...
    public function formatUrlKey(\Magento\Catalog\Model\Product $product)
    {
        ...
        $validReplacements = [
            ...
            '{sku}' => $product->getSku(),
            '{id}' => $product->getId(),
            '{brand}' => $this->getProductAttributeText($product->getId(), 'thuong_hieu'),
     ...
     *
     * @return \RosalynShop\RebuildUrl\Model\ResourceModel\Product\Url
     */
