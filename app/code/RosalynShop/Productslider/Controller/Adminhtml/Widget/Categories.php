...
namespace RosalynShop\Productslider\Controller\Adminhtml\Widget;
...
class Categories extends \Magento\Widget\Controller\Adminhtml\Widget\Instance
{
    ...
    public function execute()
    {
        ...
        $chooser = $this->layout->createBlock('RosalynShop\Productslider\Block\Adminhtml\Widget\Category\Chooser')
