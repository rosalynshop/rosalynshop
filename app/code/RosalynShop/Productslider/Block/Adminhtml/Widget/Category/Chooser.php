...
namespace RosalynShop\Productslider\Block\Adminhtml\Widget\Category;
...
class Chooser extends \Magento\Catalog\Block\Adminhtml\Category\Widget\Chooser
{
     ...
     * @var string
     */
    protected $_template = 'RosalynShop_Productslider::widget/catalog/category/widget/tree.phtml';
