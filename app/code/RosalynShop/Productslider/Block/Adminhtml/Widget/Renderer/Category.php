...
namespace RosalynShop\Productslider\Block\Adminhtml\Widget\Renderer;
...
class Category extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'RosalynShop_Productslider::widget/category.phtml';
    ...
    {
        return $this->getUrl('rsproductslider/widget/categories', ['_current' => true]);
    }
