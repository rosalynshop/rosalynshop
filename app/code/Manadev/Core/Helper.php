...
class Helper {
    ...
    public function handleHttpAndLogAllQueries($object, $proceed, $args) {
        if ($this->configuration->logAllPageQueries()) {
            $this->queryLogger->begin('page-queries');
            $this->configureHttpQueryLogging($this->queryLogger);
        }
        ...
        if ($this->configuration->logAllPageQueries()) {
            $this->queryLogger->end('page-queries');
        }

        return $result;
    }

    public function configureHttpQueryLogging(QueryLogger $queryLogger) {
    }
}